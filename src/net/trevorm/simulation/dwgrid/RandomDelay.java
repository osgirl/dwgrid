 ...
 *  RandomDelay
 * 
 *  Class implementing a dynamic demand model using multiple random delays. 
 ...
 *
 */
public class RandomDelay extends Dishwasher {
	
	/**
	 * Constructor for RandomDelay object. 
